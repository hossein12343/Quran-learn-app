          ...
          : ListView(
              ...
              children: [
                Text(
                  ...
                  'نگه می‌دارد — هر سطح تازه مهر و موم شده فردا مرور می‌شود، '
                  'و هر بار که تمیز رد شود فاصلهٔ بعدی بیشتر می‌شود. یک اشتباه '
                  'فاصله را کوتاه می‌کند، اما پیشرفت سطح را از صفر شروع '
                  'نمی‌کند.',
